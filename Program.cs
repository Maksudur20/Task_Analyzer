...
try
{
    ...
    // If VerifyConnection completes without throwing, the connection is considered successful.
    // Log success or proceed silently. For example, you could add:
    // builder.Logging.AddConsole(); // Ensure console logging is configured if not already
